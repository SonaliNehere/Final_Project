            ...
            {props.address.map((item) => (
              <RadioGroup.Option
                ...
                className={({ active, checked }) =>
                  `${
                    active
                      ? ' bg-zomato-100 ring-2 ring-offset-2 ring-offset-zomato-300 ring-white ring-opacity-60'
                      : ''
                  }
                  ${
                    checked ? ' bg-opacity-75 text-zomato-600' : 'bg-white'
                  }
...
function CheckIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <circle cx={12} cy={12} r={12} fill="#1e002" opacity="0.2" />
      <path
        d="M7 13l3 3 7-7"
        stroke="#fff"
        strokeWidth={1.5}
