...
const ImageGrid = (props) => {
    return (
        <>
           <div className="w-full h-60 md:hidden md:overflow-hidden">
            ...
            <div className="hidden w-full h-96  md:flex gap-3">
                ...
                <div className="w-1/4 h-full flex flex-col gap-1 overflow-hidden">
                    ...
                    <h4 className="absolute inset-y-2/4 z-20 w-full h-full 
